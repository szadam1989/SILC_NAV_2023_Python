...
database['VNEVEM'] = database['VNEVEM'].str.replace('Ë', 'E')
...
database['UNEVEM'] = database['UNEVEM'].str.replace('Ë', 'E')
...
database['SZVNEVE'] = database['SZVNEVE'].str.replace('Ë', 'E')
...
database['SZUNEVE'] = database['SZUNEVE'].str.replace('Ë', 'E')
...
database['AVNEVE'] = database['AVNEVE'].str.replace('Ë', 'E')
...
database['AUNEVE'] = database['AUNEVE'].str.replace('Ë', 'E')
