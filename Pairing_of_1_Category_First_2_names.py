...
file_save = 'Talalt_Parok_1._kat_b_PYTHON.txt'
...
for index, x in SILC.iterrows():
    ...
    for ind, y in database_Subset.iterrows():
        ...
        Mother_Name_Diff = stringdist.levenshtein(" ".join([SILC_Mother_Name[0], SILC_Mother_Name[1]]), " ".join([y['AVNEVE'], MotherFirstName[0]]))
